...
const JobCard = ({ job }) => {
  ...
  return (
    <article className="relative job-card rounded-4xl border border-outline/70 bg-surface shadow-[0_25px_60px_rgba(37,99,235,0.12)] transition-transform duration-300 hover:-translate-y-1 hover:shadow-xl">
