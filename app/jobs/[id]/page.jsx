...
const page = async ({ params }) => {
  ...
  return (
    <main className=" p-3 relative bg-surface">
      ...
      <header className="mb-8 rounded-lg border border-gray-200 p-6 bg-linear-to-br from-white to-gray-50 shadow-sm">
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 mt-6 items-center">
              <div className="flex items-center gap-2">
                <div className="w-9 h-9 bg-blue-400/20 flex items-center justify-center rounded-xl">
              ...
              {salary_range && (
                <div className="flex items-center gap-2">
                  <div className="w-9 h-9 bg-amber-400/20 flex items-center justify-center rounded-xl">
              ...
              <div className="flex items-center gap-2">
                <div className="w-9 h-9 bg-tertiary/20 flex items-center justify-center rounded-xl">
